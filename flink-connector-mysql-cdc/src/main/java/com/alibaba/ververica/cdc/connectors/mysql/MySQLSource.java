...
public class MySQLSource {
	...
	public static class Builder<T> {
		...
		private long sourcePosLoggingInterval;
		...
		public Builder<T> sourcePosLoggingInterval(long sourcePosLoggingInterval) {
			this.sourcePosLoggingInterval = sourcePosLoggingInterval;
			return this;
		}
		...
		public DebeziumSourceFunction<T> build() {
			...
			props.put("source-pos-logging-interval", sourcePosLoggingInterval);
